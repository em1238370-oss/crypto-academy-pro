...
## ✅ Сделано
- 2026-05-08 — KRO `trust_report`: если нет срабатывания «флагов» с цитатой, вкладка «Доказательства» заполняется отрывками из той же выборки постов (`citations`); чеклист чуть длиннее (220 симв.); подсказка в `#kro-check-channel` — нужен @ник из ссылки, не заголовок канала.
