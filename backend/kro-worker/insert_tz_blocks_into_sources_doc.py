...
4. Пример правильной последовательности (время строго по порядку, по сетке 5 мин):
   ...
   — 00:15 — За последние 10 минут новых объектов по фильтрам не найдено, источники доступны.
   — 00:20 — TGStat/Telega: найдено 12 новых сигнал‑каналов, добавлены в таблицу «Объекты и риск».
   — 00:25 — За последние 10 минут новых объектов по фильтрам не найдено, источники доступны.
...
2. Отбирай только те каналы, которые: связаны с криптой/трейдингом; дают сигналы или обещают доход; продают VIP, курсы, платные подписки.
...
«Жалоб в открытых источниках не найдено (поиск по Telegram и интернету).»
"""
