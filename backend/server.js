...
function buildSheetOnlyContentAnalysisV2(row, fetchFailed) {
  ...
  return {
    ...
    verification: {
      data_origin_ru:
        'Только ячейки строки scam_base в Google Sheets; текст постов канала в этот блок не подставлялся.',
      how_to_verify_ru:
        'Сверьте с таблицей и колонками «Источник» / доказательства; откройте ссылку на канал при необходимости.',
    },
    sheet_facts: facts,
  };
}
