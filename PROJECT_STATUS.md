# 📊 СТАТУС ПРОЕКТА — Check your crypto

**Сайт:** Крипта без розовых очков · Check your crypto

---

## 🎯 О ПРОЕКТЕ

**Check your crypto** — сервис проверки каналов и антискам:
- 🔍 Чекер каналов и обменников (KRO), живая статистика (LIVE)
- 📋 Форма «Сообщить о разводе», топ скам-каналов
- 📰 Подсайты: News, Risk, Crypto Basics, Crypto Coach
- 🌐 Деплой на Render
